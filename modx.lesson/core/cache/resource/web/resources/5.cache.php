<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1505651133,
    'editedby' => 1,
    'editedon' => 1506516303,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1505651100,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<head>
	...
	<title>Mongolab - Всі послуги</title>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-2 col-sm-4 col-xs-12"><div class="footer-column">
							...
							<img src="" alt="Mongolab" class="logo-footer">
							<p><br></p>
						...
						<div class="col-lg-3 col-sm-4 col-xs-12"><div class="footer-column">
							...
							<nav class="footer-menu">
								<ul class=""><li class="first"><a href="/" >Головна сторінка</a></li><li class="active"><a href="poslugi.html" >Всі послуги</a></li><li><a href="faq.html" >FAQ</a></li><li><a href="kontakti.html" >Контакти</a></li><li class="last"><a href="pro-nas.html" >Про нас</a></li></ul>
							</nav>

						</div></div>
						<div class="col-lg-3 col-sm-4 col-xs-12"><div class="footer-column">
							
							<p class="footer-addr"><i class="fa fa-location-arrow"></i></p>
							<p class="footer-addr"><i class="fa fa-clock-o"></i></p>
...
',
    ...
    '[[pdoField? &docid=`1` &field=`galleryHead`]]' => '',
    '[[pdoField? &docid=`1` &field=`galleryText`]]' => '',
    '[[pdoField? &docid=`1` &field=`galleryText2`]]' => '',
    ...
    '[[pdoMenu? &parents=`0` &level=`1`]]' => '<ul class=""><li class="first"><a href="/" >Головна сторінка</a></li><li class="active"><a href="poslugi.html" >Всі послуги</a></li><li><a href="faq.html" >FAQ</a></li><li><a href="kontakti.html" >Контакти</a></li><li class="last"><a href="pro-nas.html" >Про нас</a></li></ul>',
    '[[$my-footer]]' => '
		</div>
  	<div id="my-footer">
